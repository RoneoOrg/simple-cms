...
export class EditorToolbar extends React.Component {
  ...
  renderDeployPreviewControls = label => {
    ...
    return (
      <PreviewButtonContainer key="deploy-preview-ready">
        {deployPreviewReady ? (
  ...
  renderNewEntryWorkflowPublishControls = ({ canCreate, canPublish }) => {
    ...
    return canPublish ? (
      <ToolbarDropdown
        key="workflow-publish-new-entry"
        dropdownTopOverlap="40px"
        dropdownWidth="150px"
        renderButton={() => (
          <PublishButton>
      ...
      >
        ...
        {canCreate ? (
          <>
            <DropdownItem
              key="workflow-publish-and-new"
              label={t('editor.editorToolbar.publishAndCreateNew')}
              icon="add"
              onClick={onPublishAndNew}
            />
            <DropdownItem
              key="workflow-publish-and-duplicate"
  ...
  renderExistingEntrySimplePublishControls = ({ canCreate }) => {
    ...
    return canCreate ? (
      ...
      <PublishedButton key="publish-button">{t('editor.editorToolbar.published')}</PublishedButton>
    );
  };
  ...
  renderNewEntrySimplePublishControls = ({ canCreate }) => {
    ...
    return (
      <div key="simple-publish-controls">
        <ToolbarDropdown
          dropdownTopOverlap="40px"
          dropdownWidth="150px"
          renderButton={() => (
