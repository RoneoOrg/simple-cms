...
declare module 'react-redux-toastr' {
  ...
  interface ToastrEmitter {
      ...
      error: (message: string, options?: BasicToastrOptions) => void;
      error: (title: string, message: string, options?: BasicToastrOptions) => void;
      info: (message: string, options?: BasicToastrOptions) => void;
      info: (title: string, message: string, options?: BasicToastrOptions) => void;
      light: (message: string, options?: BasicToastrOptions) => void;
      ...
      success: (message: string, options?: BasicToastrOptions) => void;
      success: (title: string, message: string, options?: BasicToastrOptions) => void;
      warning: (message: string, options?: BasicToastrOptions) => void;
